...
dir_path = "./generated-pcbs/battery-dc-dc-converter-panel"
...
command = [
    ...
    "./battery-dc-dc-converter/battery-dc-dc-converter.kicad_pcb",
    f"{dir_path}/battery-dc-dc-converter-panel.kicad_pcb"
]
...
# in {dir_path}/battery-dc-dc-converter-panel.kicad_pro

with open(f"{dir_path}/battery-dc-dc-converter-panel.kicad_pro", "r") as file:
    content = file.read()

content = content.replace('"lib_footprint_issues": "warning",', '"lib_footprint_issues": "ignore",')

with open(f"{dir_path}/battery-dc-dc-converter-panel.kicad_pro", "w") as file:
    file.write(content)
